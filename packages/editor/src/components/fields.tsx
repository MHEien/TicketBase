...
import { usePuck, type Config } from '@measured/puck';
...
function PageSettingsToolbarInputs({ title, setTitle, slug, setSlug, isPreviewMode }: {
  title?: string;
  setTitle: (title: string) => void;
  slug?: string;
  setSlug: (slug: string) => void;
...
// --- Enhanced Page Settings Modal with Local State Management ---
