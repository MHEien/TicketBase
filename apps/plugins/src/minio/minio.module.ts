      ...
      useFactory: (configService: ConfigService) => {
        ...
        return {
          ...
          port: hasPort 
            ...
            : (endpoint.includes('.dev') || endpoint.includes('.com') || endpoint.includes('.io') || endpoint.includes('.net'))
              ? undefined // Skip port for custom domains
              : portFromConfig, 
          useSSL: endpoint.startsWith('https://') || configService.get('S3_USE_SSL', 'false') === 'true',
