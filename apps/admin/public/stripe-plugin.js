...
var require_get_hostname = __commonJS({
  "../../../../node_modules/next/dist/shared/lib/get-hostname.js"(exports) {
    ...
    function getHostname(parsed, headers2) {
      let hostname;
      if ((headers2 == null ? void 0 : headers2.host) && !Array.isArray(headers2.host)) {
...
var require_response = __commonJS({
  "../../../../node_modules/next/dist/server/web/spec-extension/response.js"(exports) {
    ...
    function handleMiddlewareField(init2, headers2) {
      var _init_request;
      if (init2 == null ? void 0 : (_init_request = init2.request) == null ? void 0 : _init_request.headers) {
    ...
    var NextResponse2 = class extends Response {
      constructor(body, init2 = {}) {
        ...
        this[INTERNALS] = {
          ...
          url: init2.url ? new _nexturl.NextURL(init2.url, {
      ...
      static redirect(url, init2) {
        const status = typeof init2 === "number" ? init2 : (init2 == null ? void 0 : init2.status) ?? 307;
...
var require_ua_parser = __commonJS({
  "../../../../node_modules/next/dist/compiled/ua-parser-js/ua-parser.js"(exports, module) {
    (() => {
      var i4 = { 226: function(i5, e3) {
        (function(o4, a3) {
          "use strict";
          var r3 = "1.0.35", t2 = "", n2 = "?", s3 = "function", b2 = "undefined", w3 = "object", l3 = "string", d3 = "major", c3 = "model", u4 = "name", p3 = "type", m = "vendor", f4 = "version", h3 = "architecture", v2 = "console", g2 = "mobile", k3 = "tablet", x3 = "smarttv", _3 = "wearable", y2 = "embedded", q2 = 350;
          var T3 = "Amazon", S2 = "Apple", z2 = "ASUS", N2 = "BlackBerry", A3 = "Browser", C3 = "Chrome", E2 = "Edge", O2 = "Firefox", U2 = "Google", j3 = "Huawei", P3 = "LG", R = "Microsoft", M2 = "Motorola", B = "Opera", V2 = "Samsung", D2 = "Sharp", I2 = "Sony", W = "Viera", F2 = "Xiaomi", G = "Zebra", H = "Facebook", L3 = "Chromium OS", Z2 = "Mac OS";
          var extend2 = function(i6, e4) {
            ...
            return typeof i6 === l3 ? lowerize(e4).indexOf(lowerize(i6)) !== -1 : false;
          }, lowerize = function(i6) {
            return i6.toLowerCase();
          }, majorize = function(i6) {
            return typeof i6 === l3 ? i6.replace(/[^\d\.]/g, t2).split(".")[0] : a3;
          ...
          var rgxMapper = function(i6, e4) {
            var o5 = 0, r4, t3, n3, b3, l4, d4;
            while (o5 < e4.length && !l4) {
              var c4 = e4[o5], u5 = e4[o5 + 1];
              r4 = t3 = 0;
                  ...
                  for (n3 = 0; n3 < u5.length; n3++) {
                    ...
                    if (typeof b3 === w3 && b3.length > 0) {
                      if (b3.length === 2) {
                        ...
                        if (typeof b3[1] === s3 && !(b3[1].exec && b3[1].test)) {
                          this[b3[0]] = d4 ? b3[1].call(this, d4, b3[2]) : a3;
                        } else {
                          this[b3[0]] = d4 ? d4.replace(b3[1], b3[2]) : a3;
                        }
                      } else if (b3.length === 4) {
                        this[b3[0]] = d4 ? b3[3].call(this, d4.replace(b3[1], b3[2])) : a3;
                      }
                    } else {
                      this[b3] = d4 ? d4 : a3;
                    }
          ...
          var K = { browser: [[/\b(?:crmo|crios)\/([\w\.]+)/i], [f4, [u4, "Chrome"]], [/edg(?:e|ios|a)?\/([\w\.]+)/i], [f4, [u4, "Edge"]], [/(opera mini)\/([-\w\.]+)/i, /(opera [mobiletab]{3,6})\b.+version\/([-\w\.]+)/i, /(opera)(?:.+version\/|[\/ ]+)([\w\.]+)/i], [u4, f4], [/opios[\/ ]+([\w\.]+)/i], [f4, [u4, B + " Mini"]], [/\bopr\/([\w\.]+)/i], [f4, [u4, B]], [/(kindle)\/([\w\.]+)/i, /(lunascape|maxthon|netfront|jasmine|blazer)[\/ ]?([\w\.]*)/i, /(avant |iemobile|slim)(?:browser)?[\/ ]?([\w\.]*)/i, /(ba?idubrowser)[\/ ]?([\w\.]+)/i, /(?:ms|\()(ie) ([\w\.]+)/i, /(flock|rockmelt|midori|epiphany|silk|skyfire|bolt|iron|vivaldi|iridium|phantomjs|bowser|quark|qupzilla|falkon|rekonq|puffin|brave|whale(?!.+naver)|qqbrowserlite|qq|duckduckgo)\/([-\w\.]+)/i, /(heytap|ovi)browser\/([\d\.]+)/i, /(weibo)__([\d\.]+)/i], [u4, f4], [/(?:\buc? ?browser|(?:juc.+)ucweb)[\/ ]?([\w\.]+)/i], [f4, [u4, "UC" + A3]], [/microm.+\bqbcore\/([\w\.]+)/i, /\bqbcore\/([\w\.]+).+microm/i], [f4, [u4, "WeChat(Win) Desktop"]], [/micromessenger\/([\w\.]+)/i], [f4, [u4, "WeChat"]], [/konqueror\/([\w\.]+)/i], [f4, [u4, "Konqueror"]], [/trident.+rv[: ]([\w\.]{1,9})\b.+like gecko/i], [f4, [u4, "IE"]], [/ya(?:search)?browser\/([\w\.]+)/i], [f4, [u4, "Yandex"]], [/(avast|avg)\/([\w\.]+)/i], [[u4, /(.+)/, "$1 Secure " + A3], f4], [/\bfocus\/([\w\.]+)/i], [f4, [u4, O2 + " Focus"]], [/\bopt\/([\w\.]+)/i], [f4, [u4, B + " Touch"]], [/coc_coc\w+\/([\w\.]+)/i], [f4, [u4, "Coc Coc"]], [/dolfin\/([\w\.]+)/i], [f4, [u4, "Dolphin"]], [/coast\/([\w\.]+)/i], [f4, [u4, B + " Coast"]], [/miuibrowser\/([\w\.]+)/i], [f4, [u4, "MIUI " + A3]], [/fxios\/([-\w\.]+)/i], [f4, [u4, O2]], [/\bqihu|(qi?ho?o?|360)browser/i], [[u4, "360 " + A3]], [/(oculus|samsung|sailfish|huawei)browser\/([\w\.]+)/i], [[u4, /(.+)/, "$1 " + A3], f4], [/(comodo_dragon)\/([\w\.]+)/i], [[u4, /_/g, " "], f4], [/(electron)\/([\w\.]+) safari/i, /(tesla)(?: qtcarbrowser|\/(20\d\d\.[-\w\.]+))/i, /m?(qqbrowser|baiduboxapp|2345Explorer)[\/ ]?([\w\.]+)/i], [u4, f4], [/(metasr)[\/ ]?([\w\.]+)/i, /(lbbrowser)/i, /\[(linkedin)app\]/i], [u4], [/((?:fban\/fbios|fb_iab\/fb4a)(?!.+fbav)|;fbav\/([\w\.]+);)/i], [[u4, H], f4], [/(kakao(?:talk|story))[\/ ]([\w\.]+)/i, /(naver)\(.*?(\d+\.[\w\.]+).*\)/i, /safari (line)\/([\w\.]+)/i, /\b(line)\/([\w\.]+)\/iab/i, /(chromium|instagram)[\/ ]([-\w\.]+)/i], [u4, f4], [/\bgsa\/([\w\.]+) .*safari\//i], [f4, [u4, "GSA"]], [/musical_ly(?:.+app_?version\/|_)([\w\.]+)/i], [f4, [u4, "TikTok"]], [/headlesschrome(?:\/([\w\.]+)| )/i], [f4, [u4, C3 + " Headless"]], [/ wv\).+(chrome)\/([\w\.]+)/i], [[u4, C3 + " WebView"], f4], [/droid.+ version\/([\w\.]+)\b.+(?:mobile safari|safari)/i], [f4, [u4, "Android " + A3]], [/(chrome|omniweb|arora|[tizenoka]{5} ?browser)\/v?([\w\.]+)/i], [u4, f4], [/version\/([\w\.\,]+) .*mobile\/\w+ (safari)/i], [f4, [u4, "Mobile Safari"]], [/version\/([\w(\.|\,)]+) .*(mobile ?safari|safari)/i], [f4, u4], [/webkit.+?(mobile ?safari|safari)(\/[\w\.]+)/i], [u4, [f4, strMapper, $2]], [/(webkit|khtml)\/([\w\.]+)/i], [u4, f4], [/(navigator|netscape\d?)\/([-\w\.]+)/i], [[u4, "Netscape"], f4], [/mobile vr; rv:([\w\.]+)\).+firefox/i], [f4, [u4, O2 + " Reality"]], [/ekiohf.+(flow)\/([\w\.]+)/i, /(swiftfox)/i, /(icedragon|iceweasel|camino|chimera|fennec|maemo browser|minimo|conkeror|klar)[\/ ]?([\w\.\+]+)/i, /(seamonkey|k-meleon|icecat|iceape|firebird|phoenix|palemoon|basilisk|waterfox)\/([-\w\.]+)$/i, /(firefox)\/([\w\.]+)/i, /(mozilla)\/([\w\.]+) .+rv\:.+gecko\/\d+/i, /(polaris|lynx|dillo|icab|doris|amaya|w3m|netsurf|sleipnir|obigo|mosaic|(?:go|ice|up)[\. ]?browser)[-\/ ]?v?([\w\.]+)/i, /(links) \(([\w\.]+)/i, /panasonic;(viera)/i], [u4, f4], [/(cobalt)\/([\w\.]+)/i], [u4, [f4, /master.|lts./, ""]]], cpu: [[/(?:(amd|x(?:(?:86|64)[-_])?|wow|win)64)[;\)]/i], [[h3, "amd64"]], [/(ia32(?=;))/i], [[h3, lowerize]], [/((?:i[346]|x)86)[;\)]/i], [[h3, "ia32"]], [/\b(aarch64|arm(v?8e?l?|_?64))\b/i], [[h3, "arm64"]], [/\b(arm(?:v[67])?ht?n?[fl]p?)\b/i], [[h3, "armhf"]], [/windows (ce|mobile); ppc;/i], [[h3, "arm"]], [/((?:ppc|powerpc)(?:64)?)(?: mac|;|\))/i], [[h3, /ower/, t2, lowerize]], [/(sun4\w)[;\)]/i], [[h3, "sparc"]], [/((?:avr32|ia64(?=;))|68k(?=\))|\barm(?=v(?:[1-7]|[5-7]1)l?|;|eabi)|(?=atmel )avr|(?:irix|mips|sparc)(?:64)?\b|pa-risc)/i], [[h3, lowerize]]], device: [[/\b(sch-i[89]0\d|shw-m380s|sm-[ptx]\w{2,4}|gt-[pn]\d{2,4}|sgh-t8[56]9|nexus 10)/i], [c3, [m, V2], [p3, k3]], [/\b((?:s[cgp]h|gt|sm)-\w+|sc[g-]?[\d]+a?|galaxy nexus)/i, /samsung[- ]([-\w]+)/i, /sec-(sgh\w+)/i], [c3, [m, V2], [p3, g2]], [/(?:\/|\()(ip(?:hone|od)[\w, ]*)(?:\/|;)/i], [c3, [m, S2], [p3, g2]], [/\((ipad);[-\w\),; ]+apple/i, /applecoremedia\/[\w\.]+ \((ipad)/i, /\b(ipad)\d\d?,\d\d?[;\]].+ios/i], [c3, [m, S2], [p3, k3]], [/(macintosh);/i], [c3, [m, S2]], [/\b(sh-?[altvz]?\d\d[a-ekm]?)/i], [c3, [m, D2], [p3, g2]], [/\b((?:ag[rs][23]?|bah2?|sht?|btv)-a?[lw]\d{2})\b(?!.+d\/s)/i], [c3, [m, j3], [p3, k3]], [/(?:huawei|honor)([-\w ]+)[;\)]/i, /\b(nexus 6p|\w{2,4}e?-[atu]?[ln][\dx][012359c][adn]?)\b(?!.+d\/s)/i], [c3, [m, j3], [p3, g2]], [/\b(poco[\w ]+)(?: bui|\))/i, /\b; (\w+) build\/hm\1/i, /\b(hm[-_ ]?note?[_ ]?(?:\d\w)?) bui/i, /\b(redmi[\-_ ]?(?:note|k)?[\w_ ]+)(?: bui|\))/i, /\b(mi[-_ ]?(?:a\d|one|one[_ ]plus|note lte|max|cc)?[_ ]?(?:\d?\w?)[_ ]?(?:plus|se|lite)?)(?: bui|\))/i], [[c3, /_/g, " "], [m, F2], [p3, g2]], [/\b(mi[-_ ]?(?:pad)(?:[\w_ ]+))(?: bui|\))/i], [[c3, /_/g, " "], [m, F2], [p3, k3]], [/; (\w+) bui.+ oppo/i, /\b(cph[12]\d{3}|p(?:af|c[al]|d\w|e[ar])[mt]\d0|x9007|a101op)\b/i], [c3, [m, "OPPO"], [p3, g2]], [/vivo (\w+)(?: bui|\))/i, /\b(v[12]\d{3}\w?[at])(?: bui|;)/i], [c3, [m, "Vivo"], [p3, g2]], [/\b(rmx[12]\d{3})(?: bui|;|\))/i], [c3, [m, "Realme"], [p3, g2]], [/\b(milestone|droid(?:[2-4x]| (?:bionic|x2|pro|razr))?:?( 4g)?)\b[\w ]+build\//i, /\bmot(?:orola)?[- ](\w*)/i, /((?:moto[\w\(\) ]+|xt\d{3,4}|nexus 6)(?= bui|\)))/i], [c3, [m, M2], [p3, g2]], [/\b(mz60\d|xoom[2 ]{0,2}) build\//i], [c3, [m, M2], [p3, k3]], [/((?=lg)?[vl]k\-?\d{3}) bui| 3\.[-\w; ]{10}lg?-([06cv9]{3,4})/i], [c3, [m, P3], [p3, k3]], [/(lm(?:-?f100[nv]?|-[\w\.]+)(?= bui|\))|nexus [45])/i, /\blg[-e;\/ ]+((?!browser|netcast|android tv)\w+)/i, /\blg-?([\d\w]+) bui/i], [c3, [m, P3], [p3, g2]], [/(ideatab[-\w ]+)/i, /lenovo ?(s[56]000[-\w]+|tab(?:[\w ]+)|yt[-\d\w]{6}|tb[-\d\w]{6})/i], [c3, [m, "Lenovo"], [p3, k3]], [/(?:maemo|nokia).*(n900|lumia \d+)/i, /nokia[-_ ]?([-\w\.]*)/i], [[c3, /_/g, " "], [m, "Nokia"], [p3, g2]], [/(pixel c)\b/i], [c3, [m, U2], [p3, k3]], [/droid.+; (pixel[\daxl ]{0,6})(?: bui|\))/i], [c3, [m, U2], [p3, g2]], [/droid.+ (a?\d[0-2]{2}so|[c-g]\d{4}|so[-gl]\w+|xq-a\w[4-7][12])(?= bui|\).+chrome\/(?![1-6]{0,1}\d\.))/i], [c3, [m, I2], [p3, g2]], [/sony tablet [ps]/i, /\b(?:sony)?sgp\w+(?: bui|\))/i], [[c3, "Xperia Tablet"], [m, I2], [p3, k3]], [/ (kb2005|in20[12]5|be20[12][59])\b/i, /(?:one)?(?:plus)? (a\d0\d\d)(?: b|\))/i], [c3, [m, "OnePlus"], [p3, g2]], [/(alexa)webm/i, /(kf[a-z]{2}wi|aeo[c-r]{2})( bui|\))/i, /(kf[a-z]+)( bui|\)).+silk\//i], [c3, [m, T3], [p3, k3]], [/((?:sd|kf)[0349hijorstuw]+)( bui|\)).+silk\//i], [[c3, /(.+)/g, "Fire Phone $1"], [m, T3], [p3, g2]], [/(playbook);[-\w\),; ]+(rim)/i], [c3, m, [p3, k3]], [/\b((?:bb[a-f]|st[hv])100-\d)/i, /\(bb10; (\w+)/i], [c3, [m, N2], [p3, g2]], [/(?:\b|asus_)(transfo[prime ]{4,10} \w+|eeepc|slider \w+|nexus 7|padfone|p00[cj])/i], [c3, [m, z2], [p3, k3]], [/ (z[bes]6[027][012][km][ls]|zenfone \d\w?)\b/i], [c3, [m, z2], [p3, g2]], [/(nexus 9)/i], [c3, [m, "HTC"], [p3, k3]], [/(htc)[-;_ ]{1,2}([\w ]+(?=\)| bui)|\w+)/i, /(zte)[- ]([\w ]+?)(?: bui|\/|\))/i, /(alcatel|geeksphone|nexian|panasonic(?!(?:;|\.))|sony(?!-bra))[-_ ]?([-\w]*)/i], [m, [c3, /_/g, " "], [p3, g2]], [/droid.+; ([ab][1-7]-?[0178a]\d\d?)/i], [c3, [m, "Acer"], [p3, k3]], [/droid.+; (m[1-5] note) bui/i, /\bmz-([-\w]{2,})/i], [c3, [m, "Meizu"], [p3, g2]], [/(blackberry|benq|palm(?=\-)|sonyericsson|acer|asus|dell|meizu|motorola|polytron)[-_ ]?([-\w]*)/i, /(hp) ([\w ]+\w)/i, /(asus)-?(\w+)/i, /(microsoft); (lumia[\w ]+)/i, /(lenovo)[-_ ]?([-\w]+)/i, /(jolla)/i, /(oppo) ?([\w ]+) bui/i], [m, c3, [p3, g2]], [/(kobo)\s(ereader|touch)/i, /(archos) (gamepad2?)/i, /(hp).+(touchpad(?!.+tablet)|tablet)/i, /(kindle)\/([\w\.]+)/i, /(nook)[\w ]+build\/(\w+)/i, /(dell) (strea[kpr\d ]*[\dko])/i, /(le[- ]+pan)[- ]+(\w{1,9}) bui/i, /(trinity)[- ]*(t\d{3}) bui/i, /(gigaset)[- ]+(q\w{1,9}) bui/i, /(vodafone) ([\w ]+)(?:\)| bui)/i], [m, c3, [p3, k3]], [/(surface duo)/i], [c3, [m, R], [p3, k3]], [/droid [\d\.]+; (fp\du?)(?: b|\))/i], [c3, [m, "Fairphone"], [p3, g2]], [/(u304aa)/i], [c3, [m, "AT&T"], [p3, g2]], [/\bsie-(\w*)/i], [c3, [m, "Siemens"], [p3, g2]], [/\b(rct\w+) b/i], [c3, [m, "RCA"], [p3, k3]], [/\b(venue[\d ]{2,7}) b/i], [c3, [m, "Dell"], [p3, k3]], [/\b(q(?:mv|ta)\w+) b/i], [c3, [m, "Verizon"], [p3, k3]], [/\b(?:barnes[& ]+noble |bn[rt])([\w\+ ]*) b/i], [c3, [m, "Barnes & Noble"], [p3, k3]], [/\b(tm\d{3}\w+) b/i], [c3, [m, "NuVision"], [p3, k3]], [/\b(k88) b/i], [c3, [m, "ZTE"], [p3, k3]], [/\b(nx\d{3}j) b/i], [c3, [m, "ZTE"], [p3, g2]], [/\b(gen\d{3}) b.+49h/i], [c3, [m, "Swiss"], [p3, g2]], [/\b(zur\d{3}) b/i], [c3, [m, "Swiss"], [p3, k3]], [/\b((zeki)?tb.*\b) b/i], [c3, [m, "Zeki"], [p3, k3]], [/\b([yr]\d{2}) b/i, /\b(dragon[- ]+touch |dt)(\w{5}) b/i], [[m, "Dragon Touch"], c3, [p3, k3]], [/\b(ns-?\w{0,9}) b/i], [c3, [m, "Insignia"], [p3, k3]], [/\b((nxa|next)-?\w{0,9}) b/i], [c3, [m, "NextBook"], [p3, k3]], [/\b(xtreme\_)?(v(1[045]|2[015]|[3469]0|7[05])) b/i], [[m, "Voice"], c3, [p3, g2]], [/\b(lvtel\-)?(v1[12]) b/i], [[m, "LvTel"], c3, [p3, g2]], [/\b(ph-1) /i], [c3, [m, "Essential"], [p3, g2]], [/\b(v(100md|700na|7011|917g).*\b) b/i], [c3, [m, "Envizen"], [p3, k3]], [/\b(trio[-\w\. ]+) b/i], [c3, [m, "MachSpeed"], [p3, k3]], [/\btu_(1491) b/i], [c3, [m, "Rotor"], [p3, k3]], [/(shield[\w ]+) b/i], [c3, [m, "Nvidia"], [p3, k3]], [/(sprint) (\w+)/i], [m, c3, [p3, g2]], [/(kin\.[onetw]{3})/i], [[c3, /\./g, " "], [m, R], [p3, g2]], [/droid.+; (cc6666?|et5[16]|mc[239][23]x?|vc8[03]x?)\)/i], [c3, [m, G], [p3, k3]], [/droid.+; (ec30|ps20|tc[2-8]\d[kx])\)/i], [c3, [m, G], [p3, g2]], [/smart-tv.+(samsung)/i], [m, [p3, x3]], [/hbbtv.+maple;(\d+)/i], [[c3, /^/, "SmartTV"], [m, V2], [p3, x3]], [/(nux; netcast.+smarttv|lg (netcast\.tv-201\d|android tv))/i], [[m, P3], [p3, x3]], [/(apple) ?tv/i], [m, [c3, S2 + " TV"], [p3, x3]], [/crkey/i], [[c3, C3 + "cast"], [m, U2], [p3, x3]], [/droid.+aft(\w)( bui|\))/i], [c3, [m, T3], [p3, x3]], [/\(dtv[\);].+(aquos)/i, /(aquos-tv[\w ]+)\)/i], [c3, [m, D2], [p3, x3]], [/(bravia[\w ]+)( bui|\))/i], [c3, [m, I2], [p3, x3]], [/(mitv-\w{5}) bui/i], [c3, [m, F2], [p3, x3]], [/Hbbtv.*(technisat) (.*);/i], [m, c3, [p3, x3]], [/\b(roku)[\dx]*[\)\/]((?:dvp-)?[\d\.]*)/i, /hbbtv\/\d+\.\d+\.\d+ +\([\w\+ ]*; *([\w\d][^;]*);([^;]*)/i], [[m, trim2], [c3, trim2], [p3, x3]], [/\b(android tv|smart[- ]?tv|opera tv|tv; rv:)\b/i], [[p3, x3]], [/(ouya)/i, /(nintendo) ([wids3utch]+)/i], [m, c3, [p3, v2]], [/droid.+; (shield) bui/i], [c3, [m, "Nvidia"], [p3, v2]], [/(playstation [345portablevi]+)/i], [c3, [m, I2], [p3, v2]], [/\b(xbox(?: one)?(?!; xbox))[\); ]/i], [c3, [m, R], [p3, v2]], [/((pebble))app/i], [m, c3, [p3, _3]], [/(watch)(?: ?os[,\/]|\d,\d\/)[\d\.]+/i], [c3, [m, S2], [p3, _3]], [/droid.+; (glass) \d/i], [c3, [m, U2], [p3, _3]], [/droid.+; (wt63?0{2,3})\)/i], [c3, [m, G], [p3, _3]], [/(quest( 2| pro)?)/i], [c3, [m, H], [p3, _3]], [/(tesla)(?: qtcarbrowser|\/[-\w\.]+)/i], [m, [p3, y2]], [/(aeobc)\b/i], [c3, [m, T3], [p3, y2]], [/droid .+?; ([^;]+?)(?: bui|\) applew).+? mobile safari/i], [c3, [p3, g2]], [/droid .+?; ([^;]+?)(?: bui|\) applew).+?(?! mobile) safari/i], [c3, [p3, k3]], [/\b((tablet|tab)[;\/]|focus\/\d(?!.+mobile))/i], [[p3, k3]], [/(phone|mobile(?:[;\/]| [ \w\/\.]*safari)|pda(?=.+windows ce))/i], [[p3, g2]], [/(android[-\w\. ]{0,9});.+buil/i], [c3, [m, "Generic"]]], engine: [[/windows.+ edge\/([\w\.]+)/i], [f4, [u4, E2 + "HTML"]], [/webkit\/537\.36.+chrome\/(?!27)([\w\.]+)/i], [f4, [u4, "Blink"]], [/(presto)\/([\w\.]+)/i, /(webkit|trident|netfront|netsurf|amaya|lynx|w3m|goanna)\/([\w\.]+)/i, /ekioh(flow)\/([\w\.]+)/i, /(khtml|tasman|links)[\/ ]\(?([\w\.]+)/i, /(icab)[\/ ]([23]\.[\d\.]+)/i, /\b(libweb)/i], [u4, f4], [/rv\:([\w\.]{1,9})\b.+(gecko)/i], [f4, u4]], os: [[/microsoft (windows) (vista|xp)/i], [u4, f4], [/(windows) nt 6\.2; (arm)/i, /(windows (?:phone(?: os)?|mobile))[\/ ]?([\d\.\w ]*)/i, /(windows)[\/ ]?([ntce\d\. ]+\w)(?!.+xbox)/i], [u4, [f4, strMapper, X]], [/(win(?=3|9|n)|win 9x )([nt\d\.]+)/i], [[u4, "Windows"], [f4, strMapper, X]], [/ip[honead]{2,4}\b(?:.*os ([\w]+) like mac|; opera)/i, /ios;fbsv\/([\d\.]+)/i, /cfnetwork\/.+darwin/i], [[f4, /_/g, "."], [u4, "iOS"]], [/(mac os x) ?([\w\. ]*)/i, /(macintosh|mac_powerpc\b)(?!.+haiku)/i], [[u4, Z2], [f4, /_/g, "."]], [/droid ([\w\.]+)\b.+(android[- ]x86|harmonyos)/i], [f4, u4], [/(android|webos|qnx|bada|rim tablet os|maemo|meego|sailfish)[-\/ ]?([\w\.]*)/i, /(blackberry)\w*\/([\w\.]*)/i, /(tizen|kaios)[\/ ]([\w\.]+)/i, /\((series40);/i], [u4, f4], [/\(bb(10);/i], [f4, [u4, N2]], [/(?:symbian ?os|symbos|s60(?=;)|series60)[-\/ ]?([\w\.]*)/i], [f4, [u4, "Symbian"]], [/mozilla\/[\d\.]+ \((?:mobile|tablet|tv|mobile; [\w ]+); rv:.+ gecko\/([\w\.]+)/i], [f4, [u4, O2 + " OS"]], [/web0s;.+rt(tv)/i, /\b(?:hp)?wos(?:browser)?\/([\w\.]+)/i], [f4, [u4, "webOS"]], [/watch(?: ?os[,\/]|\d,\d\/)([\d\.]+)/i], [f4, [u4, "watchOS"]], [/crkey\/([\d\.]+)/i], [f4, [u4, C3 + "cast"]], [/(cros) [\w]+(?:\)| ([\w\.]+)\b)/i], [[u4, L3], f4], [/panasonic;(viera)/i, /(netrange)mmh/i, /(nettv)\/(\d+\.[\w\.]+)/i, /(nintendo|playstation) ([wids345portablevuch]+)/i, /(xbox); +xbox ([^\);]+)/i, /\b(joli|palm)\b ?(?:os)?\/?([\w\.]*)/i, /(mint)[\/\(\) ]?(\w*)/i, /(mageia|vectorlinux)[; ]/i, /([kxln]?ubuntu|debian|suse|opensuse|gentoo|arch(?= linux)|slackware|fedora|mandriva|centos|pclinuxos|red ?hat|zenwalk|linpus|raspbian|plan 9|minix|risc os|contiki|deepin|manjaro|elementary os|sabayon|linspire)(?: gnu\/linux)?(?: enterprise)?(?:[- ]linux)?(?:-gnu)?[-\/ ]?(?!chrom|package)([-\w\.]*)/i, /(hurd|linux) ?([\w\.]*)/i, /(gnu) ?([\w\.]*)/i, /\b([-frentopcghs]{0,5}bsd|dragonfly)[\/ ]?(?!amd|[ix346]{1,2}86)([\w\.]*)/i, /(haiku) (\w+)/i], [u4, f4], [/(sunos) ?([\w\.\d]*)/i], [[u4, "Solaris"], f4], [/((?:open)?solaris)[-\/ ]?([\w\.]*)/i, /(aix) ((\d)(?=\.|\)| )[\w\.])*/i, /\b(beos|os\/2|amigaos|morphos|openvms|fuchsia|hp-ux|serenityos)/i, /(unix) ?([\w\.]*)/i], [u4, f4]] };
          var UAParser = function(i6, e4) {
            ...
            this.getDevice = function() {
              ...
              if (_4 && i7[c3] == "Macintosh" && r4 && typeof r4.standalone !== b2 && r4.maxTouchPoints && r4.maxTouchPoints > 2) {
                i7[c3] = "iPad";
                i7[p3] = k3;
              }
              return i7;
            ...
            this.getOS = function() {
              ...
              if (_4 && !i7[u4] && v3 && v3.platform != "Unknown") {
                i7[u4] = v3.platform.replace(/chrome os/i, L3).replace(/macos/i, Z2);
              }
              return i7;
            };
      ...
      constructor(headers2) {
        ...
        this.headers = new Proxy(headers2, {
          get(target, prop, receiver) {
            ...
            const original = Object.keys(headers2).find((o3) => o3.toLowerCase() === lowercased);
...
function PaymentMethodComponent({
  ...
  return <div className="p-4 border rounded-lg"><form onSubmit={handleSubmit}><div className="space-y-4">
    <div>
      <label
        htmlFor="card-number"
    ...
    <button
      ...
      disabled={processing}
    >{processing ? "Processing..." : `Pay ${(amount / 100).toFixed(2)} ${currency}`}</button>
  </div></form></div>;
}
...
var AxiosHeaders = class {
  ...
  set(header, valueOrRewrite, rewrite) {
    ...
    const setHeaders = (headers2, _rewrite) => utils_default.forEach(headers2, (_value, _header2) => setHeader(_value, _header2, _rewrite));
...
async function signOut(options) {
  const { redirect: redirect2 = true, redirectTo = options?.callbackUrl ?? window.location.href } = options ?? {};
...
var iv_default = (alg2) => crypto.getRandomValues(new Uint8Array(bitLength(alg2) >> 3));
...
var concatSalt = (alg2, p2sInput) => concat(encoder.encode(alg2), new Uint8Array([0]), p2sInput);
...
var cek_default = (alg2) => crypto.getRandomValues(new Uint8Array(bitLength2(alg2) >> 3));
...
var decrypt_key_management_default = async (alg2, key, encryptedKey, joseHeader, options) => {
  switch (alg2) {
    case "dir": {
...
var encrypt_key_management_default = async (alg2, enc2, key, providedCek, providedParameters = {}) => {
  let encryptedKey;
  let parameters;
  let cek;
  switch (alg2) {
    ...
    case "ECDH-ES+A256KW": {
      ...
      if (kty === "EC")
        parameters.epk.y = y2;
      if (apu)
        parameters.apu = encode3(apu);
      if (apv)
        parameters.apv = encode3(apv);
      if (alg2 === "ECDH-ES") {
        cek = sharedSecret;
        break;
      }
...
var FlattenedEncrypt = class {
  ...
  async encrypt(key, options) {
    ...
    validate_crit_default(JWEInvalid, /* @__PURE__ */ new Map(), options?.crit, __privateGet(this, _protectedHeader), joseHeader);
    if (joseHeader.zip !== void 0) {
      throw new JOSENotSupported('JWE "zip" (Compression Algorithm) Header Parameter is not supported.');
    }
    const { alg: alg2, enc: enc2 } = joseHeader;
    ...
    let cek;
    {
      let parameters;
      const k3 = await normalize_key_default(key, alg2);
      ({ cek, encryptedKey, parameters } = await encrypt_key_management_default(alg2, enc2, k3, __privateGet(this, _cek), __privateGet(this, _keyManagementParameters)));
      if (parameters) {
    ...
    let aadMember;
    if (__privateGet(this, _protectedHeader)) {
      protectedHeader = encoder.encode(encode3(JSON.stringify(__privateGet(this, _protectedHeader))));
    } else {
    ...
    const { ciphertext, tag: tag2, iv } = await encrypt_default(enc2, __privateGet(this, _plaintext), cek, __privateGet(this, _iv), additionalData);
    const jwe = {
...
var EncryptJWT = class {
  ...
  async encrypt(key, options) {
    ...
    if (__privateGet(this, _keyManagementParameters2)) {
      enc2.setKeyManagementParameters(__privateGet(this, _keyManagementParameters2));
    }
...
async function encode4(params) {
  ...
  return await new EncryptJWT(token).setProtectedHeader({ alg, enc, kid: thumbprint }).setIssuedAt().setExpirationTime(now2() + maxAge).setJti(crypto.randomUUID()).encrypt(encryptionSecret);
}
...
async function init({ authOptions: config, providerId, action, url, cookies: reqCookies, callbackUrl: reqCallbackUrl, csrfToken: reqCsrfToken, csrfDisabled, isPost }) {
  ...
  const options = {
    ...
    // @ts-expect-errors
    provider,
    cookies: merge2(defaultCookies(config.useSecureCookies ?? url.protocol === "https:"), config.cookies),
    providers,
    // Session options
    session: {
...
async function getSetPublicJwkCache(key) {
  const { kty, e: e2, n: n2, x: x3, y: y2, crv } = await crypto.subtle.exportKey("jwk", key);
...
var _header, _privateKey, _publicKey, _clockSkew, _modifyAssertion, _map, _jkt, _get, get_fn, _set, set_fn;
var DPoPHandler = class {
  ...
  async addProof(url, headers2, htm, accessToken) {
    ...
    headers2.set("dpop", await signJwt(__privateGet(this, _header), payload, __privateGet(this, _privateKey)));
  }
  cacheNonce(response) {
    try {
      const nonce2 = response.headers.get("dpop-nonce");
      if (nonce2) {
        __privateMethod(this, _set, set_fn).call(this, new URL(response.url).origin, nonce2);
      }
    } catch {
    }
  }
...
async function processAuthorizationCodeOpenIDResponse(as, client, response, expectedNonce, maxAge, options) {
  ...
  if (maxAge !== skipAuthTimeCheck) {
    ...
    if (claims.auth_time + maxAge < now3 - tolerance) {
      throw OPE("too much time has elapsed since the last End-User authentication", JWT_TIMESTAMP_CHECK, { claims, now: now3, tolerance, claim: "auth_time" });
    }
  }
...
async function validateJwt(jws, checkAlg, clockSkew2, clockTolerance2, decryptJwt) {
  ...
  if (claims.exp !== void 0) {
    ...
    if (claims.exp <= now3 - clockTolerance2) {
      throw OPE('unexpected JWT "exp" (expiration time) claim value, expiration is past current timestamp', JWT_TIMESTAMP_CHECK, { claims, now: now3, tolerance: clockTolerance2, claim: "exp" });
    }
  }
...
async function callback(request, options, sessionStore, cookies2) {
  ...
  const { provider, adapter, url, callbackUrl, pages, jwt, events, callbacks, session: { strategy: sessionStrategy, maxAge: sessionMaxAge }, logger: logger2 } = options;
  const useJwtSession = sessionStrategy === "jwt";
  try {
    if (provider.type === "oauth" || provider.type === "oidc") {
...
async function session(options, sessionStore, cookies2, isUpdate, newSession) {
  const { adapter, jwt, events, callbacks, logger: logger2, session: { strategy: sessionStrategy, maxAge: sessionMaxAge } } = options;
  const response = {
    body: null,
    headers: {
      "Content-Type": "application/json",
...
async function getAuthorizationUrl(query, options) {
  ...
  logger2.debug("authorization url is ready", { url, cookies: cookies2, provider });
...
async function signOut2(cookies2, sessionStore, options) {
  const { jwt, events, callbackUrl: redirect2, logger: logger2, session: session2 } = options;
  const sessionToken = sessionStore.value;
  if (!sessionToken)
    return { redirect: redirect2, cookies: cookies2 };
  try {
...
function initAuth(config, onLazyLoad) {
  if (typeof config === "function") {
    return async (...args) => {
      ...
      onLazyLoad?.(_config);
      return getSession2(new Headers(request.headers), _config).then(async (authResponse) => {
  ...
  return (...args) => {
    if (!args.length) {
      return Promise.resolve((0, import_headers.headers)()).then((h3) => getSession2(h3, config).then((r3) => r3.json()));
    }
    if (args[0] instanceof Request) {
      const req = args[0];
      const ev = args[1];
...
async function handleAuth(args, config, userMiddlewareOrRoute) {
  ...
  if (authorized instanceof Response) {
    ...
    if (redirect2 && isSameAuthAction(pathname, new URL(redirect2).pathname, config)) {
      authorized = true;
    }
  } else if (userMiddlewareOrRoute) {
    const augmentedReq = request;
    augmentedReq.auth = auth2;
    response = await userMiddlewareOrRoute(augmentedReq, args[1]) ?? import_server2.NextResponse.next();
  } else if (!authorized) {
...
async function signIn2(provider, options = {}, authorizationParams, config) {
  ...
  for (const providerConfig of config.providers) {
    const { options: options2, ...defaults2 } = typeof providerConfig === "function" ? providerConfig() : providerConfig;
...
// ../../lib/auth.ts
var apiBaseUrl2 = process.env.NEXT_PUBLIC_API_URL || "http://localhost:4000/api";
var authConfig = {
  pages: {
    signIn: "/login",
    error: "/login"
  ...
  callbacks: {
    ...
    async jwt({ token, user }) {
      ...
      if (token.error === "MaxRefreshAttemptsExceeded" || token.error === "RefreshAccessTokenError" || token.error === "NoRefreshToken") {
        console.log(
      ...
      if (token.expiresAt && typeof token.expiresAt === "number" && now3 < token.expiresAt) {
        return token;
      }
...
async function refreshAccessToken(token) {
  try {
    ...
    return {
      ...
      expiresAt: Math.floor(Date.now() / 1e3) + (refreshedTokens.expiresIn || 900),
      refreshRetryCount: 0,
...
var { auth, signIn: signIn3, signOut: signOut4, handlers } = NextAuth(authConfig);
...
function isTokenRefreshError(error) {
  ...
  if (typeof error === "string") {
    return error.includes("refresh token") || error.includes("RefreshAccessTokenError") || error.includes("401") || error.includes("Unauthorized");
  }
  if (error.message) {
...
apiClient.interceptors.response.use(
  ...
  async (error) => {
    ...
    if (error.response?.status === 401 && isTokenRefreshError(error.response?.data) && shouldRedirect) {
  ...
  return <form onSubmit={handleSubmit} className="space-y-4">
    <div>
      ...
      <input
        ...
        required
      />
      <p className="mt-1 text-xs text-gray-500">Your Stripe API key is used to process payments. You can find it in your Stripe dashboard.</p>
    </div>
    <div>
      <label
        htmlFor="webhookUrl"
      ...
      <input
        ...
        disabled={isSaving}
      />
      <p className="mt-1 text-xs text-gray-500">Stripe will send payment events to this URL. Optional if you're only using client-side checkout.</p>
    </div>
    <div className="flex items-center">
      <input
        ...
        disabled={isSaving}
      />
      <label htmlFor="testMode" className="ml-2 block text-sm text-gray-700">Test Mode</label>
    </div>
    {error && <div className="text-red-500 text-sm">{error}</div>}
    {saved && <div className="text-green-500 text-sm">Settings saved successfully!</div>}
    <div className="flex justify-end"><button
      type="submit"
      className="inline-flex justify-center py-2 px-4 border border-transparent shadow-sm text-sm font-medium rounded-md text-white bg-blue-600 hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500"
      disabled={isSaving}
    >{isSaving ? "Saving..." : "Save Settings"}</button></div>
  </form>;
}

// index.tsx
var TypedPaymentMethodComponent = registerExtensionPoint(({ context, configuration, plugin }) => {
  const { cart } = context;
...
export {
  stripe_plugin_default as default
};
