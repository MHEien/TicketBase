      ...
      children: [
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsxs(FormItem, {
                      children: [
                        ...
                        /* @__PURE__ */ jsxRuntimeExports.jsx(FormControl, {
                          children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                            Input,
                            { placeholder: "United States", ...field },
                          ),
                        }),
                        /* @__PURE__ */ jsxRuntimeExports.jsx(FormMessage, {}),
                      ],
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", {
          ...
          children: /* @__PURE__ */ jsxRuntimeExports.jsx(Button, {
            type: "submit",
            disabled: isLoading,
            children: isLoading ? "Saving..." : "Next: Event Preferences",
          }),
        }),
      ],
    }),
...
var Slider$1 = reactExports.forwardRef((props, forwardedRef) => {
  const {
    name,
    min = 0,
    max = 100,
...
var SliderHorizontal = reactExports.forwardRef((props, forwardedRef) => {
  const {
    min,
    max,
    dir,
...
var SliderVertical = reactExports.forwardRef((props, forwardedRef) => {
  const {
    min,
    max,
    inverted,
...
var SliderImpl = reactExports.forwardRef((props, forwardedRef) => {
  const {
    __scopeSlider,
    onSlideStart,
    onSlideMove,
...
var SliderTrack = reactExports.forwardRef((props, forwardedRef) => {
...
var SliderThumbImpl = reactExports.forwardRef((props, forwardedRef) => {
...
const Slider = reactExports.forwardRef(({ className, ...props }, ref) =>
  /* @__PURE__ */ jsxRuntimeExports.jsxs(Root, {
    ref,
    className: cn(
...
const eventPreferencesSchema = objectType({
  categories: arrayType(stringType()).min(1, {
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", {
                  ...
                  children: [
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsx(FormDescription, {
                      children:
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", {
                  ...
                  children: eventCategoryOptions.map((option) =>
                    /* @__PURE__ */ jsxRuntimeExports.jsx(
                      FormField,
                      {
                        control: form.control,
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(FormField, {
          ...
          render: ({ field }) =>
            /* @__PURE__ */ jsxRuntimeExports.jsxs(FormItem, {
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(FormLabel, {
                  children: "Typical Number of Attendees",
                }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(FormControl, {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(FormField, {
          ...
          render: ({ field }) =>
            /* @__PURE__ */ jsxRuntimeExports.jsxs(FormItem, {
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(FormLabel, {
                  children: "How often do you host events?",
                }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(FormControl, {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(FormField, {
          ...
          render: ({ field }) =>
            /* @__PURE__ */ jsxRuntimeExports.jsxs(FormItem, {
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(FormLabel, {
                  children: "Where do you typically host events?",
                }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(FormDescription, {
                  children:
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", {
          ...
          children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(Button, {
              type: "submit",
              disabled: isLoading,
              children: isLoading ? "Saving..." : "Next: Brand Settings",
            }),
          ],
        }),
      ],
      ...
      children: [
          ...
          children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", {
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", {
                  className:
                    "w-full h-32 rounded-md flex items-center justify-center text-white font-bold text-xl",
                  style: previewStyle,
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(FormField, {
              ...
              render: ({ field }) =>
                /* @__PURE__ */ jsxRuntimeExports.jsxs(FormItem, {
                  children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx(FormLabel, {
                      children: "Secondary Color (Optional)",
                    }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx(FormControl, {
                      children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", {
                        className: "flex items-center space-x-2",
          ...
          render: ({ field }) =>
            /* @__PURE__ */ jsxRuntimeExports.jsxs(FormItem, {
              children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx(FormDescription, {
                  children: "The currency you'll primarily sell tickets in",
                }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(FormControl, {
                  children: /* @__PURE__ */ jsxRuntimeExports.jsx("select", {
                    ...
                    children: currencyOptions.map((currency) =>
                      /* @__PURE__ */ jsxRuntimeExports.jsx(
                        "option",
                        { value: currency.value, children: currency.label },
                        currency.value,
                      ),
                    ),
                  }),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(FormField, {
          ...
          render: ({ field }) =>
            /* @__PURE__ */ jsxRuntimeExports.jsxs(FormItem, {
              className:
                "flex flex-row items-center justify-between rounded-md border p-4",
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", {
          ...
          children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(Button, {
              type: "submit",
              disabled: isLoading,
              children: isLoading ? "Saving..." : "Next: Payment Settings",
            }),
          ],
        }),
      ],
...
const paymentDetailsSchema = objectType({
  preferredPaymentMethods: arrayType(stringType()).min(1, {
    ...
    children: /* @__PURE__ */ jsxRuntimeExports.jsxs("form", {
      ...
      children: [
          ...
          render: () =>
            /* @__PURE__ */ jsxRuntimeExports.jsxs(FormItem, {
              children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", {
                  className: "space-y-2",
                  children: paymentMethodOptions.map((option) =>
                    /* @__PURE__ */ jsxRuntimeExports.jsx(
                      FormField,
                      {
                        control: form.control,
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(FormField, {
          ...
          render: ({ field }) =>
            /* @__PURE__ */ jsxRuntimeExports.jsxs(FormItem, {
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(FormLabel, {
                  children: "How do you want to handle processing fees?",
                }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(FormControl, {
                  children: /* @__PURE__ */ jsxRuntimeExports.jsx(RadioGroup, {
                    onValueChange: (value) => {
                    ...
                    defaultValue: field.value,
                    className: "flex flex-col space-y-1",
                    children: feeStrategyOptions.map((option) =>
                      /* @__PURE__ */ jsxRuntimeExports.jsxs(
                        FormItem,
                        {
                          className: "flex items-center space-x-3 space-y-0",
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(FormField, {
            ...
            render: ({ field }) =>
              /* @__PURE__ */ jsxRuntimeExports.jsxs(FormItem, {
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(FormLabel, {
                    children: "Fee Split Percentage",
                  }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx(FormDescription, {
                    children: "What percentage of fees should attendees pay?",
                  }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx(FormControl, {
                    children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", {
                      className: "space-y-3",
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", {
          ...
          children: /* @__PURE__ */ jsxRuntimeExports.jsx(FormDescription, {
...
function OnboardingComplete() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", {
    ...
    children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", {
        className:
          "w-24 h-24 rounded-full bg-green-100 dark:bg-green-900 flex items-center justify-center mb-6",
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", {
        className: "max-w-md mb-8 space-y-4",
        children: [
            ...
            children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("li", {
                ...
                children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", {
                    children: "Connect your payment processor",
                  }),
                ],
              }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("li", {
                ...
                children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", {
                    children: "Customize your ticket types",
                  }),
                ],
              }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("li", {
                ...
                children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", {
                    children: "Invite team members to collaborate",
                  }),
                ],
              }),
            ],
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Button, {
            onClick: () =>
              router.navigate({ to: "/admin/(admin)/create-event" }),
            className:
            ...
            children: steps.map((step) =>
              /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "div",
                {
                  ...
                  ${step.id < currentStep ? "bg-green-500 text-white" : step.id === currentStep ? "bg-blue-500 text-white" : "bg-gray-200 dark:bg-gray-700 text-gray-500 dark:text-gray-300"}`,
                      children:
                        step.id < currentStep
                          ? /* @__PURE__ */ jsxRuntimeExports.jsx("svg", {
                              xmlns: "http://www.w3.org/2000/svg",
                  ...
                  ${step.id === currentStep ? "text-blue-500" : "text-gray-500 dark:text-gray-400"}`,
                      children: step.title,
                    }),
                  ],
                },
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", {
                ...
                children: steps.map((step) =>
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "div",
                    {
                      className: `h-0.5 ${step.id <= currentStep ? "bg-blue-500" : "bg-transparent"}`,
                      style: {
