...
const SplitComponent = function AuthDiagnosticsPage() {
  ...
  const [hasAttemptedFetch, setHasAttemptedFetch] =
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", {
            ...
            children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("button", {
                ...
                className:
                  "bg-purple-500 hover:bg-purple-600 text-white px-4 py-2 rounded",
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("button", {
            ...
            disabled: loading,
            children: loading ? "Loading..." : "Check Session Token",
          }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("button", {
            ...
            disabled: loading,
            children: loading ? "Loading..." : "Clean Up Expired Sessions",
          }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("button", {
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("button", {
            ...
            className:
              "bg-red-700 hover:bg-red-800 text-white px-4 py-2 rounded",
            children: "Force Sign Out & Clear",
          }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("button", {
            onClick: handleResetAuth,
            className:
              "bg-orange-500 hover:bg-orange-600 text-white px-4 py-2 rounded",
            children: "Reset Auth State",
          }),
        ],
      }),
      cleanupResult &&
      ...
      tokenStatus &&
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", {
          ...
          children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("pre", {
              className: "bg-gray-100 p-4 rounded overflow-auto",
              children: JSON.stringify(tokenStatus, null, 2),
            }),
          ],
        }),
      sessionInfo &&
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", {
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("h2", {
              className: "text-xl font-semibold mb-4",
              children: "Session Diagnostics",
            }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("pre", {
              className: "bg-gray-100 p-4 rounded overflow-auto",
              children: JSON.stringify(sessionInfo, null, 2),
            }),
          ],
        }),
    ],
