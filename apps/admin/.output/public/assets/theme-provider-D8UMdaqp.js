...
const DashboardNavProvider = ({ children }) => {
  const [activeSection, setActiveSection] = reactExports.useState("overview");
  return /* @__PURE__ */ jsxRuntimeExports.jsx(DashboardNavContext.Provider, {
...
const useDashboardNav = () => {
  const { activeSection, setActiveSection } =
    reactExports.useContext(DashboardNavContext);
...
export {
  DashboardNavProvider as D,
  useDashboardNav as a,
  useTheme as b,
  useCommandMenu as u,
};
