import { c as createLucideIcon, U as getDefaultExportFromCjs, r as reactExports, V as clsx, W as withSelectorExports, X as reactDomExports, Y as invariant, Z as requireReact, j as jsxRuntimeExports, e as cn, T as Card, _ as CardContent, $ as CardHeader, a0 as apiClient, a as useRouter, B as Button, a1 as CardTitle, a2 as CardDescription, b as Badge, a3 as CardFooter, a4 as ChevronDown } from './main-D54NVj6U.js';
...
import { u as useRecentActivity, R as RefreshCw, T as TrendingUp } from './use-activity-DPkvV5M7.js';
...
import { P as PluginGallery } from './plugin-gallery-Bd5IV6zp.js';
import { b as useTheme, u as useCommandMenu, a as useDashboardNav } from './theme-provider-D8UMdaqp.js';
import { A as AnimatePresence } from './index-B_Zo_mO0.js';
import './events-api-CXruRnoF.js';
import './index-DACOVT_t.js';
import './plugin-loader-Y88a9AGU.js';
import './arrow-left-D-CnOb33.js';
import './settings-S4HBAFRa.js';
import './mail-Bwy92L3K.js';
import './search-BS6yzFHd.js';
...
var Surface = /*#__PURE__*/reactExports.forwardRef((props, ref) => {
  var {
    ...
    others = _objectWithoutProperties$n(props, _excluded$n);
  var svgView = viewBox || {
    width,
    height,
    x: 0,
  ...
  return /*#__PURE__*/reactExports.createElement("svg", _extends$s({}, filterProps(others, true, 'svg'), {
...
var Layer = /*#__PURE__*/reactExports.forwardRef((props, ref) => {
  var {
    ...
    others = _objectWithoutProperties$m(props, _excluded$m);
...
var selectChartOffsetInternal = createSelector([selectChartWidth, selectChartHeight, selectMargin, selectBrushHeight, selectAllXAxes, selectAllYAxes, selectLegendSettings, selectLegendSize], (chartWidth, chartHeight, margin, brushHeight, xAxes, yAxes, legendSettings, legendSize) => {
  var offsetH = yAxes.reduce((result, entry) => {
    ...
    if (!entry.mirror && !entry.hide) {
      ...
      return _objectSpread$x(_objectSpread$x({}, result), {}, {
...
function LegendContent(props) {
  var {
    ...
    otherProps = _objectWithoutProperties$k(props, _excluded$k);
...
var Cross = _ref => {
  ...
  return /*#__PURE__*/reactExports.createElement("path", _extends$l({}, filterProps(props, true), {
...
var hasRequiredIsPlainObject$2;

function requireIsPlainObject$2 () {
	if (hasRequiredIsPlainObject$2) return isPlainObject$3;
...
function requireIsEqualWith () {
	...
	(function (exports) {
		...
		const isPlainObject = /*@__PURE__*/ requireIsPlainObject$2();
		const getSymbols = /*@__PURE__*/ requireGetSymbols();
		const getTag = /*@__PURE__*/ requireGetTag();
		const tags = /*@__PURE__*/ requireTags();
		const eq = /*@__PURE__*/ requireEq();
...
var _excluded$i = ["children", "begin", "duration", "attributeName", "easing", "isActive", "from", "to", "canBegin", "onAnimationEnd", "shouldReAnimate", "onAnimationReStart", "animationManager"];
...
class AnimateImpl extends reactExports.PureComponent {
  constructor(props, context) {
    super(props, context);
    _defineProperty$s(this, "mounted", false);
    _defineProperty$s(this, "manager", null);
    _defineProperty$s(this, "stopJSAnimation", null);
    _defineProperty$s(this, "unSubscribe", null);
    var {
      isActive,
      attributeName,
      from,
  ...
  runAnimation(props) {
    ...
    this.manager.start([onAnimationStart, begin, _objectSpread$o(_objectSpread$o({}, to), {}, {
      transition
  ...
  render() {
    var _this$props = this.props,
      ...
      others = _objectWithoutProperties$i(_this$props, _excluded$i);
...
_defineProperty$s(AnimateImpl, "displayName", 'Animate');
_defineProperty$s(AnimateImpl, "defaultProps", {
  begin: 0,
  duration: 1000,
  attributeName: '',
  easing: 'ease',
...
function Animate(props) {
  ...
  return /*#__PURE__*/reactExports.createElement(AnimateImpl, _extends$k({}, props, {
...
var Rectangle = rectangleProps => {
  ...
  return /*#__PURE__*/reactExports.createElement(Animate, {
    ...
    }, /*#__PURE__*/reactExports.createElement("path", _extends$j({}, filterProps(props, true), {
      className: layerClass,
...
var ResponsiveContainer = /*#__PURE__*/reactExports.forwardRef((_ref, ref) => {
  ...
  return /*#__PURE__*/reactExports.createElement("div", {
    ...
    style: _objectSpread$h(_objectSpread$h({}, style), {}, {
      width,
      height,
      minWidth,
      minHeight,
...
function removeInvalidKeys(obj) {
  var copyObj = _objectSpread$g({}, obj);
...
var getStringSize = function getStringSize(text) {
  ...
  try {
    ...
    var measurementSpanStyle = _objectSpread$g(_objectSpread$g({}, SPAN_STYLE), copyStyle);
...
var _excluded$h = ["x", "y", "lineHeight", "capHeight", "scaleToFit", "textAnchor", "verticalAnchor", "fill"],
...
var Text = /*#__PURE__*/reactExports.forwardRef((_ref5, ref) => {
  var {
    ...
    props = _objectWithoutProperties$h(_ref5, _excluded$h);
  ...
  var {
    ...
    textProps = _objectWithoutProperties$h(props, _excluded2$7);
  ...
  return /*#__PURE__*/reactExports.createElement("text", _extends$g({}, filterProps(textProps, true), {
    ref: ref,
    x: x,
    y: y,
...
var _excluded$g = ["offset"],
  _excluded2$6 = ["labelRef"];
...
function Label(_ref) {
  var {
    ...
    restProps = _objectWithoutProperties$g(_ref, _excluded$g);
  ...
  if (/*#__PURE__*/reactExports.isValidElement(content)) {
    var {
      ...
      propsWithoutLabelRef = _objectWithoutProperties$g(props, _excluded2$6);
...
function LabelList(_ref) {
  var {
    ...
    restProps = _objectWithoutProperties$f(_ref, _excluded$f);
  var {
      data,
      dataKey,
      clockWise,
    ...
    others = _objectWithoutProperties$f(restProps, _excluded2$5);
  if (!data || !data.length) {
    return null;
  }
  return /*#__PURE__*/reactExports.createElement(Layer, {
    ...
    return /*#__PURE__*/reactExports.createElement(Label, _extends$e({}, filterProps(entry, true), others, idProps, {
      parentViewBox: entry.parentViewBox,
      value: value,
      textBreakAll: textBreakAll,
      viewBox: Label.parseViewBox(isNullish(clockWise) ? entry : _objectSpread$e(_objectSpread$e({}, entry), {}, {
        clockWise
      })),
...
function SetCartesianGraphicalItem(props) {
  ...
  reactExports.useEffect(() => {
    var settings = _objectSpread$c(_objectSpread$c({}, props), {}, {
...
var Trapezoid = props => {
  var trapezoidProps = resolveDefaultProps(props, defaultProps$4);
  ...
  if (!isUpdateAnimationActive) {
    return /*#__PURE__*/reactExports.createElement("g", null, /*#__PURE__*/reactExports.createElement("path", _extends$c({}, filterProps(trapezoidProps, true), {
      className: layerClass,
  ...
  return /*#__PURE__*/reactExports.createElement(Animate, {
    ...
    return /*#__PURE__*/reactExports.createElement(Animate, {
      ...
      duration: animationDuration,
      easing: animationEasing
    }, /*#__PURE__*/reactExports.createElement("path", _extends$c({}, filterProps(trapezoidProps, true), {
      className: layerClass,
...
function Shape(_ref2) {
  var {
    ...
    props = _objectWithoutProperties$e(_ref2, _excluded$e);
  var shape;
  if (/*#__PURE__*/reactExports.isValidElement(option)) {
...
var _excluded$d = ["onMouseEnter", "onClick", "onMouseLeave"];
...
function PieSectors(props) {
  ...
  var {
    ...
    restOfAllOtherProps = _objectWithoutProperties$d(allOtherPieProps, _excluded$d);
...
function PieImpl(props) {
  ...
  return /*#__PURE__*/reactExports.createElement(reactExports.Fragment, null, /*#__PURE__*/reactExports.createElement(SetTooltipEntrySettings, {
    ...
    args: _objectSpread$a(_objectSpread$a({}, propsWithDefaults), {}, {
      sectors
    })
  }), /*#__PURE__*/reactExports.createElement(PieWithTouchMove, _extends$b({}, propsWithDefaults, {
    sectors: sectors
  })));
}
class Pie extends reactExports.PureComponent {
  constructor() {
    super(...arguments);
    _defineProperty$e(this, "id", uniqueId('recharts-pie-'));
  }
  render() {
...
_defineProperty$e(Pie, "displayName", 'Pie');
_defineProperty$e(Pie, "defaultProps", defaultPieProps);
...
function SetErrorBarContext(props) {
  var {
    ...
    rest = _objectWithoutProperties$c(props, _excluded$c);
...
var _excluded$b = ["direction", "width", "dataKey", "isAnimationActive", "animationBegin", "animationDuration", "animationEasing"];
function _defineProperty$c(e, r, t) { return (r = _toPropertyKey$c(r)) in e ? Object.defineProperty(e, r, { value: t, enumerable: true, configurable: true, writable: true }) : e[r] = t, e; }
function _toPropertyKey$c(t) { var i = _toPrimitive$c(t, "string"); return "symbol" == typeof i ? i : i + ""; }
function _toPrimitive$c(t, r) { if ("object" != typeof t || !t) return t; var e = t[Symbol.toPrimitive]; if (void 0 !== e) { var i = e.call(t, r); if ("object" != typeof i) return i; throw new TypeError("@@toPrimitive must return a primitive value."); } return ("string" === r ? String : Number)(t); }
...
function ErrorBarImpl(props) {
  ...
  var errorBars = data.map(entry => {
    ...
    return /*#__PURE__*/reactExports.createElement(Layer, _extends$a({
      ...
      }, /*#__PURE__*/reactExports.createElement("line", _extends$a({}, coordinates, {
        style: lineStyle
      })));
    }));
  });
...
function ErrorBarInternal(props) {
  ...
  }), /*#__PURE__*/reactExports.createElement(ErrorBarImpl, _extends$a({}, props, {
    direction: realDirection,
    width: width,
    isAnimationActive: isAnimationActive,
...
_defineProperty$c(ErrorBar, "defaultProps", errorBarDefaultProps);
...
function typeguardBarRectangleProps(_ref, props) {
  var {
    x: xProp,
    y: yProp
  } = _ref, option = _objectWithoutProperties$a(_ref, _excluded$a);
...
var _excluded$9 = ["onMouseEnter", "onMouseLeave", "onClick"],
  _excluded2$4 = ["value", "background", "tooltipPosition"],
...
function BarBackground(props) {
  ...
  var {
    ...
    restOfAllOtherProps = _objectWithoutProperties$9(allOtherBarProps, _excluded$9);
  ...
  return /*#__PURE__*/reactExports.createElement(reactExports.Fragment, null, data.map((entry, i) => {
    var {
      ...
      rest = _objectWithoutProperties$9(entry, _excluded2$4);
...
function BarRectangles(_ref) {
  ...
  var {
    ...
    restOfAllOtherProps = _objectWithoutProperties$9(props, _excluded3$1);
  var onMouseEnterFromContext = useMouseEnterItemDispatch(onMouseEnterFromProps, dataKey);
  var onMouseLeaveFromContext = useMouseLeaveItemDispatch(onMouseLeaveFromProps);
  var onClickFromContext = useMouseClickItemDispatch(onItemClickFromProps, dataKey);
  if (!data) {
  ...
  return /*#__PURE__*/reactExports.createElement(reactExports.Fragment, null, data.map((entry, i) => {
    ...
    var barRectangleProps = _objectSpread$7(_objectSpread$7(_objectSpread$7({}, baseProps), entry), {}, {
      isActive,
      option,
      index: i,
      dataKey
...
class BarWithState extends reactExports.PureComponent {
  constructor() {
    super(...arguments);
    _defineProperty$a(this, "id", uniqueId('recharts-bar-'));
  }
  render() {
    var {
      hide,
...
_defineProperty$a(Bar, "defaultProps", defaultBarProps);
...
var selectBarRectangles = createSelector([selectChartOffsetInternal, selectXAxisWithScale$1, selectYAxisWithScale$1, selectXAxisTicks$1, selectYAxisTicks$1, selectBarPosition, selectChartLayout, selectChartDataWithIndexesIfNotInPanorama, selectAxisBandSize, selectStackedDataOfItem, selectSynchronisedBarSettings, pickCells], (offset, xAxis, yAxis, xAxisTicks, yAxisTicks, pos, layout, _ref3, bandSize, stackedData, barSettings, cells) => {
  var {
    chartData,
    dataStartIndex,
    dataEndIndex
...
class CartesianAxis extends reactExports.Component {
  ...
  shouldComponentUpdate(_ref, nextState) {
    ...
    var _this$props = this.props,
      ...
      restPropsOld = _objectWithoutProperties$8(_this$props, _excluded2$3);
  ...
  static renderTickItem(option, props, value) {
    ...
    if (/*#__PURE__*/reactExports.isValidElement(option)) {
      tickItem = /*#__PURE__*/reactExports.cloneElement(option, _objectSpread$4(_objectSpread$4({}, props), {}, {
      ...
      tickItem = /*#__PURE__*/reactExports.createElement(Text, _extends$7({}, props, {
        className: className
      }), value);
    }
    return tickItem;
  ...
  renderTicks(fontSize, letterSpacing) {
    ...
    var items = finalTicks.map((entry, i) => {
      ...
      }, adaptEventsOfChild(this.props, entry, i)), tickLine && /*#__PURE__*/reactExports.createElement("line", _extends$7({}, tickLineProps, lineCoord, {
...
function renderLineItem(option, props) {
  ...
  if (/*#__PURE__*/reactExports.isValidElement(option)) {
    ...
    var _filterProps = filterProps(others, false),
      ...
      restOfFilteredProps = _objectWithoutProperties$7(_filterProps, _excluded2$2);
...
function HorizontalGridLines(props) {
  ...
  var {
    ...
    otherLineItemProps = _objectWithoutProperties$7(props, _excluded3);
...
function VerticalGridLines(props) {
  ...
  var {
    ...
    otherLineItemProps = _objectWithoutProperties$7(props, _excluded4);
...
const ChartContext = reactExports.createContext(void 0);
function ChartContainer({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(ChartContext.Provider, { value: { config }, children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className, children }) });
}
...
function ChartTooltipContent({ active, payload, label }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "rounded-lg border bg-background p-2 shadow-sm", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid gap-2", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex items-center justify-between gap-2", children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-sm font-medium", children: label }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid gap-1", children: payload.map((item, index) => {
        ...
        "div",
        {
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-1", children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs font-medium", children: configItem.label })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs font-medium", children: typeof item.value === "number" && dataKey.includes("revenue") ? `$${item.value.toLocaleString()}` : item.value })
          ]
        },
        index
      );
        ...
        children: payload.map((item) => {
          ...
          return /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "div",
            {
              ...
              children: [
                itemConfig?.icon && !hideIcon ? itemConfig.icon : /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "div",
                  {
        ...
        AreaChart,
        {
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("defs", { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("linearGradient", { id: "colorRevenue", x1: "0", y1: "0", x2: "0", y2: "1", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "stop",
                  {
                    offset: "5%",
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("linearGradient", { id: "colorTickets", x1: "0", y1: "0", x2: "0", y2: "1", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "stop",
                  {
                    offset: "5%",
...
function DashboardLoading() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "h-full space-y-6 overflow-y-auto", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-1 gap-4 md:grid-cols-2 lg:grid-cols-4", children: Array.from({ length: 4 }).map((_, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(Card, { className: "border-transparent bg-background/60", children: /* @__PURE__ */ jsxRuntimeExports.jsx(CardContent, { className: "p-6", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start justify-between", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 gap-6 lg:grid-cols-3", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "lg:col-span-2", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(CardContent, { className: "pb-4", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Skeleton, { className: "h-[300px] w-full" }) })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "h-full", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(CardContent, { className: "space-y-4", children: Array.from({ length: 3 }).map((_, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-3", children: Array.from({ length: 3 }).map((_, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(CardHeader, { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Skeleton, { className: "h-6 w-32" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Skeleton, { className: "h-4 w-40" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(CardContent, { className: "space-y-4", children: Array.from({ length: 4 }).map((_2, j) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between", children: [
...
const analyticsApi = {
  ...
  async getRevenueChartData(startDate, endDate, granularity = "daily") {
    const params = new URLSearchParams({
      start: startDate.toISOString(),
      end: endDate.toISOString(),
      granularity
...
function useDashboard(options = {}) {
  const { refreshInterval = 3e5, autoRefresh = true } = options;
  ...
  const refreshSalesData = reactExports.useCallback(
    async (startDate, endDate) => {
      try {
        const dateRange = startDate && endDate ? { startDate, endDate } : getDateRange();
  ...
  const refreshActivity = reactExports.useCallback(async () => {
    try {
  ...
  const refreshEvents = reactExports.useCallback(async () => {
    try {
  ...
  const refreshPerformance = reactExports.useCallback(async () => {
    try {
  ...
  const refreshPlugins = reactExports.useCallback(async () => {
    try {
      ...
      const errorMessage = err instanceof Error ? err.message : "Failed to fetch popular plugins";
      setError(errorMessage);
      toast({
        title: "Error",
        description: errorMessage,
...
function WidgetDashboard() {
  const [activeWidget, setActiveWidget] = reactExports.useState(null);
  ...
  if (loading) {
    return /* @__PURE__ */ jsxRuntimeExports.jsx(DashboardLoading, {});
  }
  if (error) {
    return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex h-full items-center justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center space-y-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-lg font-semibold", children: "Failed to load dashboard" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground", children: error }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs(Button, { onClick: refresh, variant: "outline", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(RefreshCw, { className: "h-4 w-4 mr-2" }),
        "Try Again"
      ] })
    ] }) });
  }
  const upcomingEvents = events.filter((event) => new Date(event.startDate) > /* @__PURE__ */ new Date()).sort(
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "h-full space-y-6 overflow-y-auto", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground", children: "Welcome back! Here's what's happening with your events." })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs(Button, { variant: "outline", className: "gap-2", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Calendar, { className: "h-4 w-4" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "Last 30 days" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { variant: "outline", size: "icon", onClick: refresh, children: /* @__PURE__ */ jsxRuntimeExports.jsx(RefreshCw, { className: "h-4 w-4" }) })
      ] })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-1 gap-4 md:grid-cols-2 lg:grid-cols-4", children: keyMetrics.map((metric) => /* @__PURE__ */ jsxRuntimeExports.jsx(
      motion.div,
      {
        whileHover: { y: -5, transition: { duration: 0.2 } },
        className: "group",
        children: /* @__PURE__ */ jsxRuntimeExports.jsx(Card, { className: "border-transparent bg-background/60 transition-all duration-300 hover:border-primary/20 hover:bg-background/80 hover:shadow-md", children: /* @__PURE__ */ jsxRuntimeExports.jsx(CardContent, { className: "p-6", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start justify-between", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm font-medium text-muted-foreground", children: metric.title }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "mt-1 text-2xl font-bold", children: metric.value }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-1 flex items-center gap-1", children: [
              metric.trend === "up" ? /* @__PURE__ */ jsxRuntimeExports.jsx(ArrowUpRight, { className: "h-3 w-3 text-emerald-500" }) : /* @__PURE__ */ jsxRuntimeExports.jsx(ArrowDownRight, { className: "h-3 w-3 text-rose-500" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "span",
                {
                  className: metric.trend === "up" ? "text-xs text-emerald-500" : "text-xs text-rose-500",
                  children: metric.change
                }
              ),
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs text-muted-foreground", children: "vs last month" })
            ] })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "rounded-full border border-primary/10 bg-background p-2 shadow-sm", children: /* @__PURE__ */ jsxRuntimeExports.jsx(metric.icon, { className: "h-5 w-5 text-primary" }) })
        ] }) }) })
      },
      metric.id
    )) }),
          ...
          children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
            Card,
            {
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs(CardHeader, { className: "flex flex-row items-center justify-between pb-2", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx(CardTitle, { children: "Sales Overview" }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx(CardDescription, { children: "Daily ticket sales and revenue" })
                  ] }),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx(Badge, { variant: "outline", className: "rounded-full", children: "Last 30 days" }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx(
                      Button,
                      {
                        variant: "ghost",
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx(CardContent, { className: "pb-4", children: /* @__PURE__ */ jsxRuntimeExports.jsx(SalesChart, { data: data.salesData }) }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs(CardFooter, { className: "flex items-center justify-between pt-0", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-4", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-1", children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-3 w-3 rounded-full bg-primary" }),
                      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs text-muted-foreground", children: "Revenue" })
                    ] }),
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-1", children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-3 w-3 rounded-full bg-primary/30" }),
                      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs text-muted-foreground", children: "Tickets" })
                    ] })
                  ] }),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs(Button, { variant: "ghost", size: "sm", className: "gap-1 text-xs", children: [
        ...
        motion.div,
        {
          ...
          children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
            Card,
            {
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs(CardHeader, { children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(CardTitle, { children: "Upcoming Events" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx(CardDescription, { children: "Your next scheduled events" })
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(CardContent, { className: "space-y-4", children: eventsLoading ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-4", children: Array.from({ length: 3 }).map((_, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-4 bg-muted rounded animate-pulse" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-3 bg-muted rounded animate-pulse w-2/3" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-2 bg-muted rounded animate-pulse" })
                ] }, i)) }) : upcomingEvents.length > 0 ? upcomingEvents.map((event) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "font-medium", children: event.title }),
                      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-1 text-sm text-muted-foreground", children: [
                        /* @__PURE__ */ jsxRuntimeExports.jsx(Calendar, { className: "h-3 w-3" }),
                        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: new Date(event.startDate).toLocaleDateString() })
                      ] })
                    ] }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx(
                      Button,
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between text-sm", children: [
                      ...
                      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-medium", children: formatCurrency(event.totalRevenue) })
                    ] }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx(
                      Progress,
                      {
                        value: Math.min(
                          event.totalRevenue / 1e4 * 100,
                          100
                        ),
                        className: "h-2"
                      }
                ...
                ] }, event.id)) : /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-center py-4", children: /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground", children: "No upcoming events" }) }) }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(CardFooter, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Button, { variant: "outline", className: "w-full gap-1", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(Calendar, { className: "h-4 w-4" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "View All Events" })
                ] }) })
              ]
            }
          )
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-3", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        motion.div,
        {
            ...
            Card,
            {
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs(CardHeader, { children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx(CardDescription, { children: "Latest actions on your platform" })
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(CardContent, { className: "space-y-4", children: activitiesLoading ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-4", children: Array.from({ length: 3 }).map((_, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-4 bg-muted rounded animate-pulse" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-3 bg-muted rounded animate-pulse w-2/3" })
                ] }, i)) }) : recentActivities.length > 0 ? recentActivities.map((activity) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start gap-3", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsxs(Avatar, { className: "h-8 w-8", children: [
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsx(AvatarFallback, { children: activity.user.name.charAt(0) })
                  ] }),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-sm", children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-medium", children: activity.user.name }),
                      " ",
                      activity.description
                    ] }),
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-1 text-xs text-muted-foreground", children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx(Clock, { className: "h-3 w-3" }),
                      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: new Date(activity.createdAt).toLocaleString() })
                    ] })
                  ] })
                ] }, activity.id)) : /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-center py-4", children: /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground", children: "No recent activity" }) }) }),
        ...
        motion.div,
        {
          ...
          children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
            Card,
            {
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs(CardHeader, { children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(CardTitle, { children: "Popular Plugins" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx(CardDescription, { children: "Most installed extensions" })
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(CardContent, { className: "space-y-4", children: data.popularPlugins.length > 0 ? data.popularPlugins.map((plugin, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
                  "div",
                  {
                    className: "flex items-center justify-between",
                    children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3", children: [
                        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex h-9 w-9 items-center justify-center rounded-full bg-primary/10", children: [
                          /* @__PURE__ */ jsxRuntimeExports.jsx(
                            "img",
                            {
                              src: plugin.icon,
                          ...
                          /* @__PURE__ */ jsxRuntimeExports.jsx(Layers, { className: "h-5 w-5 text-primary hidden" })
                        ] }),
                        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-medium", children: plugin.name }),
                  ...
                  plugin.id
                )) : /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-center py-4", children: /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground", children: "No plugins available" }) }) }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(CardFooter, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Button, { variant: "ghost", size: "sm", className: "w-full gap-1", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(Layers, { className: "h-4 w-4" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "Browse Plugin Gallery" })
                ] }) })
              ]
            }
          )
        ...
        motion.div,
        {
          ...
          children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
            Card,
            {
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs(CardHeader, { children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(CardTitle, { children: "Performance Metrics" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx(CardDescription, { children: "Key indicators for your platform" })
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(CardContent, { className: "space-y-4", children: performanceMetrics.map((metric, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx(metric.icon, { className: "h-4 w-4 text-primary" }),
                      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-medium", children: metric.name })
                    ] }),
                    /* @__PURE__ */ jsxRuntimeExports.jsxs(Badge, { variant: "outline", className: "gap-1 rounded-full", children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx(ArrowUpRight, { className: "h-3 w-3 text-emerald-500" }),
                      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs text-emerald-500", children: metric.change })
                    ] })
                  ] }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-2xl font-bold", children: metric.value })
                ] }, i)) }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(CardFooter, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Button, { variant: "ghost", size: "sm", className: "w-full gap-1", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(ChartColumn, { className: "h-4 w-4" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "View Detailed Analytics" })
                ] }) })
              ]
            }
          )
...
const data$1 = [
  { name: "Week 1", revenue: 4e3, projected: 4200 },
  { name: "Week 2", revenue: 5e3, projected: 5100 },
  { name: "Week 3", revenue: 6e3, projected: 5800 },
  { name: "Week 4", revenue: 7e3, projected: 6900 },
  { name: "Week 5", revenue: 8e3, projected: 8200 },
  { name: "Week 6", revenue: 9500, projected: 9e3 },
  { name: "Week 7", revenue: 11e3, projected: 10500 },
  { name: "Week 8", revenue: 12500, projected: 12e3 }
];
...
function EventsMap() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative h-full w-full overflow-hidden rounded-lg bg-background", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 opacity-10", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("svg", { width: "100%", height: "100%", viewBox: "0 0 100 70", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "path",
        {
      ...
      [...Array(10)].map((_, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(
        "line",
        {
          x1: "0",
          y1: 10 + i * 6,
    ...
    loaded && /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
      locations.map((location) => /* @__PURE__ */ jsxRuntimeExports.jsx(
        motion.div,
        {
          className: "absolute",
          style: {
          ...
          children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "div",
              {
                ...
                children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "sr-only", children: location.name })
              }
            ),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute left-1/2 top-full mt-1 -translate-x-1/2 whitespace-nowrap text-xs font-medium", children: location.name })
          ] })
        },
        location.id
      )),
      /* @__PURE__ */ jsxRuntimeExports.jsx("svg", { className: "absolute inset-0 h-full w-full", children: locations.map((location, i) => {
...
function AudienceChart() {
  ...
  const [activeChart, setActiveChart] = reactExports.useState("age");
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "h-full", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(ResponsiveContainer, { width: "100%", height: "80%", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(PieChart, { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        Pie,
        {
          activeIndex,
          ...
          children: (activeChart === "age" ? data : interestData).map(
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        Tooltip,
        {
          content: ({ active, payload }) => {
            if (active && payload && payload.length) {
              return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "rounded-lg border bg-background p-2 shadow-sm", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-2 gap-2", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-1", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "div",
                    {
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-sm font-medium", children: payload[0].name })
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-right text-sm font-medium", children: [
                  payload[0].value,
                  "%"
                ] })
              ] }) });
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        Legend,
        {
          ...
          verticalAlign: "bottom",
          align: "center",
          formatter: (value, entry, index) => /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs", children: value })
        }
      )
    ] }) })
  ] });
...
function DataVisualization() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "h-full space-y-6 overflow-y-auto", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col justify-between gap-4 sm:flex-row sm:items-center", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "text-2xl font-bold tracking-tight", children: "Analytics" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground", children: "Detailed insights into your ticket sales and events." })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-wrap items-center gap-2", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs(Button, { variant: "outline", className: "gap-2", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Calendar, { className: "h-4 w-4" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "May 9 - June 9, 2025" }),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { variant: "outline", size: "icon", children: /* @__PURE__ */ jsxRuntimeExports.jsx(RefreshCw, { className: "h-4 w-4" }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { variant: "outline", size: "icon", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Download, { className: "h-4 w-4" }) })
      ] })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs(Tabs, { defaultValue: "overview", className: "space-y-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(TabsList, { className: "grid w-full grid-cols-4 lg:w-auto", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(TabsTrigger, { value: "events", children: "Events" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(TabsTrigger, { value: "audience", children: "Audience" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs(TabsContent, { value: "overview", className: "space-y-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-1 gap-4 md:grid-cols-2 lg:grid-cols-4", children: [
          {
            title: "Total Revenue",
            value: "$124,521",
            change: "+12.5%",
        ...
        ].map((metric, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(Card, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(CardContent, { className: "p-6", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm font-medium text-muted-foreground", children: metric.title }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "mt-1 text-2xl font-bold", children: metric.value }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "mt-1 text-xs text-emerald-500", children: [
              metric.change,
              " vs last period"
            ] })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "rounded-full border border-primary/10 bg-primary/5 p-2", children: /* @__PURE__ */ jsxRuntimeExports.jsx(metric.icon, { className: "h-5 w-5 text-primary" }) })
        ] }) }) }, i)) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-1 gap-4 lg:grid-cols-2", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "lg:col-span-2", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs(CardHeader, { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(CardTitle, { children: "Revenue Overview" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(CardDescription, { children: "Daily revenue from ticket sales" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(CardContent, { children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-[350px]", children: /* @__PURE__ */ jsxRuntimeExports.jsx(RevenueChart, {}) }) })
        ] }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 gap-4 lg:grid-cols-2", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs(CardHeader, { children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx(CardDescription, { children: "Where your attendees are coming from" })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(CardContent, { children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-[350px]", children: /* @__PURE__ */ jsxRuntimeExports.jsx(EventsMap, {}) }) })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs(CardHeader, { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(CardTitle, { children: "Audience Demographics" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(CardDescription, { children: "Age and interests of your attendees" })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(CardContent, { children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-[350px]", children: /* @__PURE__ */ jsxRuntimeExports.jsx(AudienceChart, {}) }) })
          ] })
        ] })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(TabsContent, { value: "sales", className: "space-y-4", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs(CardHeader, { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(CardTitle, { children: "Sales Performance" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(CardDescription, { children: "Detailed breakdown of ticket sales" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(CardContent, { children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-[400px]", children: /* @__PURE__ */ jsxRuntimeExports.jsx(SalesChart, {}) }) })
      ] }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(TabsContent, { value: "events", className: "space-y-4", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs(CardHeader, { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(CardTitle, { children: "Event Locations" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(CardDescription, { children: "Geographic distribution of your events" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(CardContent, { children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-[400px]", children: /* @__PURE__ */ jsxRuntimeExports.jsx(EventsMap, {}) }) })
      ] }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(TabsContent, { value: "audience", className: "space-y-4", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs(CardHeader, { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(CardTitle, { children: "Audience Insights" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(CardDescription, { children: "Demographics and behavior of your attendees" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(CardContent, { children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-[400px]", children: /* @__PURE__ */ jsxRuntimeExports.jsx(AudienceChart, {}) }) })
      ] }) })
    ] })
  ] });
}

const SplitComponent = function Dashboard() {
  ...
  const sections = {
    overview: /* @__PURE__ */ jsxRuntimeExports.jsx(WidgetDashboard, {}),
    analytics: /* @__PURE__ */ jsxRuntimeExports.jsx(DataVisualization, {}),
    plugins: /* @__PURE__ */ jsxRuntimeExports.jsx(PluginGallery, {})
  };
  return /* @__PURE__ */ jsxRuntimeExports.jsx(AnimatePresence, { mode: "wait", children: /* @__PURE__ */ jsxRuntimeExports.jsx(motion.div, { initial: {
    opacity: 0,
    y: 20
  }, animate: {
    opacity: 1,
    ...
    duration: 0.3
  }, className: "h-full", children: sections[activeSection] }, activeSection) });
};
