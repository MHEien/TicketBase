        ...
        <Card>
          ...
          <CardContent className="space-y-6">
            <RadioGroup
              ...
              onValueChange={(value: "physical" | "virtual" | "hybrid") => updateEventData({ locationType: value })}
              ...
              <div>
                ...
                >
                  ...
                  <div className="text-center">
                    ...
                    <p className="text-sm text-muted-foreground">Physical venue</p>
                  </div>
                </Label>
              </div>
            ...
            {(eventData.locationType === "physical" || eventData.locationType === "hybrid") && (
              <motion.div
            ...
            {(eventData.locationType === "virtual" || eventData.locationType === "hybrid") && (
              <motion.div
                initial={{ opacity: 0, height: 0 }}
                animate={{ opacity: 1, height: "auto" }}
                exit={{ opacity: 0, height: 0 }}
      ...
      >
        <Card>
          <CardHeader>
            ...
            <CardDescription>Control how your event location is displayed to attendees.</CardDescription>
          </CardHeader>
          <CardContent>
            <div className="rounded-lg border bg-muted/50 p-4">
              <p className="text-sm text-muted-foreground">
                By default, your event location will be visible to all attendees. For private events, you can choose to
                share the exact location only with registered attendees.
              </p>
            </div>
          </CardContent>
        </Card>
